...
It’s simple, elegant, and highly productive:
    ...
    Tactile Feedback: Tap or hold the screen to watch the paws go down.

    Release to Reset: Lift your finger to bring the paws back up.
...
Getting your feline percussionist set up is easy:
    ...
    Download the bongocat.koplugin folder.

    Connect your device to your computer.

    Navigate to the KOReader directory on your device (usually .koreader/plugins/ or koreader/plugins/).

    Move the bongocat.koplugin folder into that plugins directory.
...
🚀 How to Play
    ...
    Select BongoCat Plugin.

    Tap or Hold anywhere on the screen to drum.
